...
National forest inventories carried out on $753$ sites on the island of French Guiana are available, listing the presence or absence of $555$ plant species on each of these sites between 1994 and 1996.
...
Among the climatic data downloaded, concerning the whole island of French Guiana at present (interpolations of representative observed data from the years 1960-1990).
...
terra::writeRaster(scaled_clim_var,
                   "~/Documents/presentations/workshop-Metradica-March2023/jSDM_tutorial_files/scaled_clim.tif",
...
\cr 
\cr
```{r FG-fitting-mod, echo=FALSE, out.width=900, eval=TRUE}
...
load("~/Documents/presentations/workshop-Metradica-March2023/jSDM_tutorial_cache/R.csv")
# Forest inventory 
...
knitr::include_graphics("jSDM_tutorial_files/figure-html/plot-associations-1.png")
```
...
knitr::include_graphics("jSDM_tutorial_files/figure-html/plot-associations-2.png")
```
