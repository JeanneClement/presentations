...
\title[Mapping tree communities in tropical forests using JSDMs]{\LARGE {\textbf{Mapping tree communities in tropical forests using Joint Species Distribution Models}}}
%\subtitle{}
\date{}
  ...
  \ifplacelogo
      \begin{tabular}{cccc} 
       \qquad \includegraphics[height=0.8cm]{figs/logo_cnrs.png} &
        ...
        \includegraphics[height=0.9cm]{figs/AMAP.jpg} \hspace{1.5cm}
        ~
      \end{tabular}
  \fi
