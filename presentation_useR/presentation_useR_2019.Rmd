...
library(knitr)
load("~/presentations/presentation_useR/draws.RData")
...
```{r time}
load("~/presentations/presentation_useR/jSDM_boral_sim.RData")
load("~/presentations/presentation_useR/jSDM_boral_mosquito.RData")
load("~/presentations/presentation_useR/jSDM_boral_eucalypts.RData")
load("~/presentations/presentation_useR/jSDM_boral_frogs.RData")
load("~/presentations/presentation_useR/boral_fungi.RData")
load("~/presentations/presentation_useR/jSDM_fungi.RData")
