...
// [[Rcpp::export]]
Rcpp::List Rcpp_jSDM_binomial_R(const int ngibbs, int nthin, int nburn, // Number of iterations, burning and samples
  ...
  for ( int g = 0; g < NGIBBS; g++ ) {
    ...
    ////////////////////////////////////////////////
    // Metropolis algorithm : beta 
    for ( int p = 0; p < NP; p++ ) {
      // Specifying the rank of the parameter of interest
      dens_data.pos_beta = p; 
...
} // end Rcpp_jSDM_binomial function
...
#     coda::densplot(MCMC.beta[,p], main = paste0("beta_",p))
