...
\title[Mapping tree communities in tropical forests using joint species distribution models]{\LARGE {\textbf{Mapping tree communities in tropical forests using Joint Species Distribution Models}}}
%\subtitle{} 
